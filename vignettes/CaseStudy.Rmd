...
```{r}
res_old <- SelInd(w = w_old, G = G,  r = r_old, verbose = FALSE)
res_new <- SelInd(w = w_new, G = G,  r = r_new, verbose = FALSE)
```
...
```{r}
res_old <- SelInd(w = w_old, G = G,  r = r_old, h2 = h2)
res_new <- SelInd(w = w_new, G = G,  r = r_new, h2 = h2)
