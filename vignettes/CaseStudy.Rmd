...
title: "Case Study"
author:
- Henner Simianer^1,2^, Johannes Heise^3^, Stefan Rensing^3^, Torsten Pook^1,2^, Johannes Geibel^1,2^, Christian Reimer^1,2,4^
...
- ^4^Friedrich-Loeffler-Institut, Institute of Farm Animal genetics
...
If we have a certain index and want to see which effect the single traits have on the composition of the total index, several analytical measures might help.
...
This shows us that the resulting trend matches the expected well with probably slightly more weight on exterieur ("RZEo") and reproduction ("RZR").
