...
> Since V0.2.0.0, we calculate an approximate derivative by incrimenting the weight of one trait slightly, while reducing the weight of the other traits accordingly, to be able to account for the side restriction that $\sum w = 0$.
